import 'package:fleet_admin_panel/utils/arch_utils/utils/ui_utils.dart';
...
extension SizeConfigExtension on num {
  double vdp() {
    var value = this;
    return value is double ? SizeConfig.getVerticalSize(value) : SizeConfig.getVerticalSize(value.toDouble());
  }

  double hdp() {
    var value = this;
    return value is double ? SizeConfig.getHorizontalSize(value) : SizeConfig.getHorizontalSize(value.toDouble());
  }
